...
-- Sessions
INSERT INTO SESSIONS (refCreateur, nomSession, nbMaxInscritEvenement, nbMinParticipationEvenement, dateLimiteInscription, dateRappelMail) VALUES ('3', 'Soutenances RT1', '8', '2', '23-feb-2013', '20-feb-2013');
INSERT INTO SESSIONS (refCreateur, nomSession, nbMaxInscritEvenement, nbMinParticipationEvenement, dateLimiteInscription, dateRappelMail) VALUES ('3', 'Soutenances RT2', '8', '2', '23-feb-2013', '20-feb-2013');
...
-- Evenements
INSERT INTO EVENEMENTS (refSession, nomEvenement, descEvenement, dateDebutEvenement, dateFinEvenement, emplacementEvenement) VALUES ('1', 'La fête de la patate', 'Cest le jour où toutes les patates se retrouvent et dansent jusquau bout de la nuit !', TIMESTAMP '2013-03-18 10:00:00', TIMESTAMP '2013-03-18 12:00:00', 'C251');
INSERT INTO EVENEMENTS (refSession, nomEvenement, descEvenement, dateDebutEvenement, dateFinEvenement, emplacementEvenement) VALUES ('1', 'Résolution dynamique du lien fort', 'Gestion dun lien fort entre deux base de donnée avec mise à jour dynamique et gestion des exeptions', TIMESTAMP '2013-03-17 10:00:00', TIMESTAMP '2013-03-18 12:00:00', 'C251');
INSERT INTO EVENEMENTS (refSession, nomEvenement, descEvenement, dateDebutEvenement, dateFinEvenement, emplacementEvenement) VALUES ('2', 'Parallélisme dans les clusters de calcule virtuels', 'Etude les mouvements de données dans les clusters de calcule virtualisé a laide dun agent hyperviseur', TIMESTAMP '2013-03-18 14:00:00', TIMESTAMP '2013-03-18 14:30:00', 'C252');
INSERT INTO EVENEMENTS (refSession, nomEvenement, descEvenement, dateDebutEvenement, dateFinEvenement, emplacementEvenement) VALUES ('2', 'Exploration despace hostils par robots autonome', 'Programation de robots permettant de cartographier en toute autonomie des milieux hostils. Récuperation des données sur grande distance (~100 km) via une technologie sans-fil', TIMESTAMP '2013-03-18 16:00:00', TIMESTAMP '2013-03-18 18:00:00', 'C251');
